    ...
    static navigationOptions = ({ navigation }) => ({
        ...
        headerLeft: (
            <TouchableOpacity style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: 10 }}>
                <Image style={{ width: 13, height: 16 }} source={require('../../images/Public/icon_food_merchant_address.png')} />
                <Text style={{ fontSize: 15, color: '#333333' }}> 北京 中关村</Text>
            </TouchableOpacity>
        ),
